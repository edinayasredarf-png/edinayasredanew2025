-- Fix Supabase relationships and ensure proper table structure
...
-- 3. Create comments table with proper foreign key
...
-- 9. Create function to handle new user
...
-- 10. Create trigger for new user
...
-- 12. Test the relationship by creating a sample comment (optional)
