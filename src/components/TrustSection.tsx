...
const cards: Card[] = [
  ...
  },
  {
    ...
    description:
      "ГК Единая среда включает компанию Сфера и Экострой которые выполняют более 15 лет успешно заказы.",
    button: "Посмотреть на торгах",
    icon: "/icons/gov.svg",
    variant: "light",
  },
  {
    ...
    description:
      "Единая среда включает компанию Сфера и Экострой которые выполняют более 15 лет успешно заказы.",
    button: "Получить предложение",
    icon: "/icons/skolkovo.svg",
    variant: "light",
  },
];
