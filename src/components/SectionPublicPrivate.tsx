    ...
    <section className="max-w-[1480px] mx-auto px-5 md:px-8 mt-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* ========================================
            ...
            ======================================== */}
        <article className="group bg-[#F6F7F9] rounded-[20px] p-8 overflow-hidden flex flex-col md:flex-row min-h-[276px] transition-all duration-300">
          ...
          <div className="flex-shrink-0 w-full md:w-auto mt-6 md:mt-0 md:ml-1">
            ...
            <div className="p-2 bg-white rounded-2xl flex justify-center md:justify-end items-center">
        ...
        {/* ========================================
            ...
            ======================================== */}
        <article className="group bg-[#F6F7F9] rounded-[20px] p-8 overflow-hidden min-h-[276px] flex flex-col transition-all duration-300  ">
