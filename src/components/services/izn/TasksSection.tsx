  ...
  const data = {
    ...
    tasks: [
      ...
      },
      {
        ...
        description: 'Система включает возможности для получения полной и развернутой информации по каждому месту объекту. Данные можно использовать для отчетов и планирования.'
      },
      {
