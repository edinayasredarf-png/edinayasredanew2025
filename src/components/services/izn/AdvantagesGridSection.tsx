      ...
      <div className="w-full max-w-[1200px] mx-auto flex flex-col items-center gap-16 px-4">
        ...
        <div className="relative w-full h-auto lg:h-[620px]">
          ...
          <div className="hidden lg:block relative w-full h-full">
            {/* Карточка 1 */}
            <div className="absolute top-0 left-0 w-[364px] min-h-[300px] bg-[#F6F7F9] rounded-3xl flex flex-col p-2 pb-[67px]">
            ...
            <div className="absolute top-0 left-[372px] w-[736px] h-[300px] bg-[#F6F7F9] rounded-3xl flex gap-2 p-2">
              ...
              <div className="w-[356px] bg-white rounded-2xl flex items-center justify-center px-10">
                <Image
            ...
            <div className="absolute top-0 left-[1116px] w-[364px] min-h-[300px] bg-[#F6F7F9] rounded-3xl flex flex-col p-2 ">
              <div className="flex flex-col gap-3 px-7 pt-[27px] pb-7">
                <h3 className="text-[#313131] text-[28px] font-medium leading-9">
                  Безопасность данных
                </h3>
            ...
            <div className="absolute top-[308px] left-0 w-[736px] min-h-[300px] bg-[#F6F7F9] rounded-3xl flex gap-2 p-2">
              <div className="w-[356px] bg-white rounded-2xl flex items-center justify-center px-10 py-10">
                <Image
            ...
            <div className="absolute top-[308px] left-[744px] w-[736px] min-h-[300px] bg-[#F6F7F9] rounded-3xl flex gap-2 p-2">
              <div className="w-[356px] flex flex-col gap-3 px-7 pt-[27px] pb-[87px]">
