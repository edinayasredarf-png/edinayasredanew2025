			...
			<div className="mx-auto max-w-[1200px] px-5">
				...
				<div className="pt-8 pb-10 flex flex-col lg:flex-row gap-10 lg:gap-8">
					...
					<div className="shrink-0 lg:w-[220px] flex flex-col gap-5">
						<Link href="/">
							<Image src="/img/es_logo_blue.svg" alt="Единая Среда" width={150} height={35} className="w-[150px] h-auto" />
						</Link>
					...
					<div className="flex-1 grid grid-cols-1 lg:grid-cols-[1fr_1fr_1fr_1fr] gap-y-8 gap-x-6">
						...
						<div className="flex flex-col gap-4">
							...
							<ul className="space-y-3">
								...
								<li><Link href="/dlya/zhk" className="text-[16px] lg:text-[15px] text-[#646b85] leading-6 hover:text-[#029cda] transition-colors">Для ЖК и УК</Link></li>
									<li><Link href="/dlya/sanatorii" className="text-[16px] lg:text-[15px] text-[#646b85] leading-6 hover:text-[#029cda] transition-colors">Для санаториев</Link></li>
									<li><Link href="/dlya/oteli" className="text-[16px] lg:text-[15px] text-[#646b85] leading-6 hover:text-[#029cda] transition-colors">Для отелей</Link></li>
