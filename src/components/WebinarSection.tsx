...
const WebinarSection: React.FC = () => {
  return (
    <section className="bg-white w-full flex justify-center mt-16 px-4">
      <div className="w-full max-w-[1022px] bg-[#F6F7F9] rounded-3xl overflow-hidden flex flex-col md:flex-row items-stretch">
