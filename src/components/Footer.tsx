      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 pb-8">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <Link href="welcome-bonus" className="flex items-center gap-2 px-6 py-3.5 text-[#313131] text-xl font-medium rounded-xl hover:bg-gray-100 transition-colors">
              <Image src="/icons/icon6.svg" alt="" width={24} height={24} /> Приветственный бонус
            </Link>
            <a
              href="https://t.me/es_faq"
              className="flex items-center gap-2 px-6 py-3.5 text-[#313131] text-xl font-medium rounded-xl bg-[#F6F7F9] hover:bg-gray-200 transition-colors"
            >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6 md:gap-8 py-8">
          {/* Products */}
          <div>
            <h3 className="text-base md:text-xl lg:text-2xl font-medium text-[#313131] mb-3 md:mb-6 break-words leading-tight">
              Продукты
            </h3>
            <ul className="space-y-3">
              <li><a href="https://edinayasreda.ru/" className="text-base font-medium text-[#313131] hover:text-azure">Единая Среда</a></li>
              <li><a href="https://myroots.pro/" className="text-base font-medium text-[#313131] hover:text-azure">My Roots</a></li>
              <li><a href="https://oblastrazvitiya.ru/" className="text-base font-medium text-[#313131] hover:text-azure">НКО «Область Развития»</a></li>
            </ul>
          </div>

          {/* Platform */}
          <div>
            <h3 className="text-base md:text-xl lg:text-2xl font-medium text-[#313131] mb-3 md:mb-6 break-words leading-tight">Платформа</h3>
            <ul className="space-y-3">
              <li><a href="https://edinayasreda.ru/" className="text-base  font-medium text-[#313131] hover:text-azure">Войти в ЛК</a></li>
              <li><a href="https://www.rustore.ru/catalog/app/ru.edinayasreda" className="text-base font-medium text-[#313131] hover:text-azure">Мобильное приложение</a></li>
            </ul>
          </div>
          ...
          {/* Company */}
          <div>
            <h3 className="text-base md:text-xl lg:text-2xl font-medium text-[#313131] mb-3 md:mb-6 break-words leading-tight">Компания</h3>
            <ul className="space-y-3">
              <li><Link href="/about" className="text-base font-medium text-[#313131] hover:text-azure">О компании</Link></li>
              <li><Link href="/cases" className="text-base font-medium text-[#313131] hover:text-azure">Кейсы</Link></li>
              <li><Link href="/contacts" className="text-base  font-medium text-[#313131] hover:text-azure">Контакты</Link></li>
              <li><Link href="/career" className="text-base font-medium text-[#313131] hover:text-azure">Карьера</Link></li>
              <li><Link href="/partnership" className="text-base font-medium text-[#313131] hover:text-azure">Партнерство</Link></li>
            </ul>
          </div>

          {/* Conditions */}
          <div>
            <h3 className="text-base md:text-xl lg:text-2xl font-medium text-[#313131] mb-3 md:mb-6 break-words leading-tight">Условия</h3>
            <ul className="space-y-3">
              <li><Link href="/pricing" className="text-base font-medium text-[#313131] hover:text-azure">Тарифы и цены</Link></li>
            </ul>
          </div>

          {/* Support */}
          <div>
            <h3 className="text-base md:text-xl lg:text-2xl font-medium text-[#313131] mb-3 md:mb-6 break-words leading-tight">Техподдержка</h3>
            <ul className="space-y-4">
              <li>
                <Link href="/documents" className="flex items-center gap-2 text-base font-medium text-[#313131] hover:text-azure">
