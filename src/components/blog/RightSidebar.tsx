...
function AdsCarousel({ loading }: { loading?: boolean }) {
  ...
  if (loading) {
    ...
    return (
      <Skeleton variant="rectangular" width="100%" height={424} sx={{ borderRadius: 6 }} animation="wave" />
    );
  }
