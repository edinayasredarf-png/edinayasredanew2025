...
const DEFAULT_LABELS: Record<string, string> = {
  ...
  'resheniya': 'Решения',
  'municipalnye-sistemy-ucheta': 'Муниципальные системы учёта',
  'blagoustroystvo': 'Учёт объектов благоустройства',
  'uchet-zelenyh-nasazhdeniy': 'Учёт зелёных насаждений',
  'uchet-mest-zahoroneniy': 'Учёт мест захоронений',
  'programma-dlya-inventarizacii': 'Программа для инвентаризации',
  'sravnenie-sistem-inventarizacii': 'Сравнение систем инвентаризации',
  'preimushchestva': 'Преимущества «Единой среды»',
  'lesoustrojstvo': 'Лесоустройство',
  'ocifrovka-territorij': 'Оцифровка территорий',
  'inventarizaciya-kladbishch': 'Инвентаризация кладбищ',
  'luchshie-sistemy-inventarizacii': 'Лучшие системы инвентаризации',
  'reviews': 'Отзывы',
  'dlya': 'Отрасли',
  'zhk': 'Для ЖК',
  'sanatorii': 'Для санаториев',
  'oteli': 'Для отелей',
...
function BreadcrumbsDisplay({ items }: { items: BreadcrumbItem[] }) {
  ...
  return (
    <>
      ...
      <nav aria-label="Навигационная цепочка" className="breadcrumbs-wrapper font-[Raleway] bg-white">
