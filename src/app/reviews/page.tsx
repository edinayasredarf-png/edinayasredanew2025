          ...
          <div className="rd-content-column">
            <div className="max-w-3xl">
              ...
              <p className="text-lg md:text-xl leading-relaxed text-[#313131]">
                Клиенты «Единой среды» — муниципалитеты, органы власти и
                организации из 40+ регионов России — оставляют отзывы о нашей
                работе по инвентаризации зелёных насаждений, инвентаризации мест
                захоронений, лесоустройству и оцифровке городских территорий.
                Ниже — актуальные отзывы с Яндекс.Карт: они обновляются
                автоматически, каждый новый отзыв появляется на этой странице.
              </p>
