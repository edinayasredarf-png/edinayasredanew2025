...
const Case9Inner: React.FC = () => {
  ...
  const caseData = {
    ...
    client: 'Администрация города Краснодар',
    date: '2024',
    ...
    testimonial: {
      ...
      author: 'Администрация города Краснодар',
      position: 'Краснодарского края',
    },
  };
  ...
  const solutionImages: GalleryItem[] = [
    { src: '/img/cases/krasnodar-case-1.jpg', alt: 'Оцифровка территории города' },
    { src: '/img/cases/krasnodar-case-2.jpg', alt: 'Экспедиционные работы 20+ специалистов' },
    { src: '/img/cases/krasnodar-case-3.jpg', alt: 'Система управления зелеными территориями' },
  ];
          ...
          <article className="space-y-10">
            ...
            <section id="task">
              ...
              <p className="mt-4 text-lg md:text-xl leading-relaxed text-gray-800">
                Администрации требовалось определить и зафиксировать параметры всех озелененных территорий города,
                создать систематизированный учет зеленых насаждений и наладить мониторинг их состояния для
            ...
            <section id="solution">
              ...
              <p className="mt-4 text-lg md:text-xl leading-relaxed text-gray-800">
                Мы применили АИС «Единая Среда» и выстроили полный цикл: разбили территорию на учетные участки,
                выполнили оцифровку зеленых зон в ГИС, организовали полевые экспедиции с участием 20+ специалистов,
                обеспечили <strong>обработку данных в реальном времени</strong> и загрузку в единый реестр.
              </p>
            ...
            <section id="result9">
              ...
              <ul className="mt-6 space-y-4 text-lg md:text-xl leading-relaxed text-gray-800">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong>Актуальные данные по всем территориям</strong> — создана полная база зеленых зон города с
                    детальной атрибутикой и геометрией.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-2 inline-block w-2 h-2 rounded-full bg-[#029cda] flex-none shrink-0" />
                  <span>
                    <strong>План работ на ревизионный период</strong> — сформированы объемы и приоритеты содержания на
                ...
                <li className="flex items-start gap-3">
                  <span className="mt-2 inline-block w-2 h-2 rounded-full bg-[#029cda] flex-none shrink-0" />
                  <span>
                    <strong>Оперативное управление хозяйством</strong> — внедрены механизмы быстрого реагирования и
                    контроля работ.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-2 inline-block w-2 h-2 rounded-full bg-[#029cda] flex-none shrink-0" />
                  <span>
                    <strong>Рациональное расходование бюджета</strong> — {caseData.budget} за счет точного планирования
                    и исключения лишних затрат.
                  </span>
                </li>
              </ul>
            </section>
          ...
          <aside className="lg:pl-2">
            <div className="bg-white rounded-3xl p-6 md:p-8 sticky top-6">
              ...
              <nav className="mt-4 space-y-3 text-gray-800">
                ...
                <a href="#result9" className="block hover:text-[#029cda] text-base md:text-lg transition-colors">
                  Результаты
                </a>
              </nav>
