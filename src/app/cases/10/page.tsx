...
const Case10Inner: React.FC = () => {
  ...
  const caseData = {
    ...
    subtitle: 'г. Железногорск Курской области',
    client: 'Администрация г. Железногорск',
    date: '2024',
    location: 'г. Железногорск, Курская область',
    ...
    testimonial: {
      ...
      author: 'Администрация г. Железногорск',
      position: 'Курская область',
    },
  };
  ...
  const solutionImages: GalleryItem[] = [
    { src: '/img/cases/case10/case10_scan.jpg', alt: 'Мобильное лазерное сканирование' },
    { src: '/img/cases/case10/case10_digitize.jpg', alt: 'Оцифровка объектов зеленого хозяйства' },
    { src: '/img/cases/case10/case10_passport.jpg', alt: 'Паспорт зелёных насаждений 1:500' },
  ];
          ...
          <article className="space-y-10">
            ...
            <section id="task">
              ...
              <p className="mt-4 text-lg md:text-xl leading-relaxed text-gray-800">
                Выполнить техническую инвентаризацию зелёных насаждений в границах города и изготовить{' '}
                <strong>паспорт зелёных насаждений</strong> для подготовки обоснованных заданий под муниципальные контракты
                на устройство и содержание зелёного фонда.
              </p>
              <p className="mt-4 text-lg md:text-xl leading-relaxed text-gray-800">
                Нужно было собрать <strong>актуальные и достоверные сведения</strong>: видовой состав и количество, возраст и диаметры деревьев,
                учёт кустарников, площади газонов и цветников, а также текущее состояние насаждений.
              </p>
            ...
            <section id="solution">
              ...
              <p className="mt-4 text-lg md:text-xl leading-relaxed text-gray-800">
                Построили сквозной процесс с использованием АИС «Единая Среда» и мобильного лазерного сканирования:
                полевые работы, камеральная обработка, выпуск паспортной документации.
              </p>
              ...
              <ul className="mt-6 space-y-4 text-lg md:text-xl leading-relaxed text-gray-800">
                <li className="flex items-start gap-3">
                  ...
                  <span><strong>Мобильное лазерное сканирование</strong> — полная съёмка улично-дорожной сети и озеленённых территорий.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-2 inline-block w-2 h-2 rounded-full bg-[#029cda]" />
                  <span><strong>Оцифровка объектов</strong> — деревья, кустарники, газоны, цветники внесены в единый реестр и снабжены атрибутами.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-2 inline-block w-2 h-2 rounded-full bg-[#029cda]" />
                  <span><strong>Паспортизация</strong> — планы 1:500, ведомости сплошного перечёта и сводные таблицы для контрактов.</span>
                </li>
              </ul>
            </section>
            ...
            <section id="result10">
              ...
              <ul className="mt-6 space-y-4 text-lg md:text-xl leading-relaxed text-gray-800">
                <li className="flex items-start gap-3">
                  ...
                  <span><strong>{caseData.budget}</strong> на благоустройство — значительное увеличение доступного финансирования.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-2 inline-block w-2 h-2 rounded-full bg-[#029cda] flex-none shrink-0" />
                  <span><strong>Сэкономлены средства муниципального бюджета</strong> за счёт точного планирования объёмов и требований к работам.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-2 inline-block w-2 h-2 rounded-full bg-[#029cda] flex-none shrink-0" />
                  <span><strong>Система контроля подрядчика</strong> — прозрачный мониторинг качества и сроков по контрактам на озеленение.</span>
                </li>
              </ul>
            </section>
          ...
          <aside className="lg:pl-2">
            <div className="bg-white rounded-3xl p-6 md:p-8 sticky top-6">
              ...
              <nav className="mt-4 space-y-3 text-gray-800">
                <a href="#task" className="block hover:text-[#029cda] text-base md:text-lg transition-colors">Задача</a>
                <a href="#solution" className="block hover:text-[#029cda] text-base md:text-lg transition-colors">Решение</a>
                <a href="#result10" className="block hover:text-[#029cda] text-base md:text-lg transition-colors">Результаты</a>
              </nav>
