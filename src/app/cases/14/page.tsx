...
const Case14Inner: React.FC = () => {
  ...
  const caseData = {
    ...
    subtitle: 'г. Краснодар, Краснодарский край',
    client: 'Управление образования г. Краснодар',
    date: '2024',
    ...
    testimonial: {
      ...
      author: 'Управление образования г. Краснодар',
      position: 'Краснодарский край',
    },
  };
  ...
  const solutionImages: GalleryItem[] = [
    { src: '/img/cases/krasnodar-safety-case-1.jpg', alt: 'Визуальный осмотр объектов озеленения' },
    { src: '/img/cases/krasnodar-safety-case-2.jpg', alt: 'Оценка состояния деревьев и выявление аварийности' },
    { src: '/img/cases/krasnodar-safety-case-3.jpg', alt: 'База данных и фотофиксация каждого растения' },
  ];
          ...
          <article className="space-y-10">
            ...
            <section id="task">
              ...
              <p className="mt-4 text-lg md:text-xl leading-relaxed text-gray-800">
                Обеспечить <strong>безопасность детей и персонала</strong> в детских садах и школах: выявить
                потенциально опасные насаждения, систематизировать информацию по каждому объекту озеленения и
                подготовить <strong>дорожную карту мероприятий</strong> по снижению рисков.
              </p>
            ...
            <section id="solution">
              ...
              <p className="mt-4 text-lg md:text-xl leading-relaxed text-gray-800">
                Провели комплексную инвентаризацию с участием дендрологов и специалистов по безопасности: от
                <strong> визуального осмотра</strong> и диагностики до <strong>фотофиксации</strong>, ведения
                централизованной БД и подготовки <strong>плана мероприятий</strong> (обрезка, лечение, удаление,
            ...
            <section id="result14">
              ...
              <ul className="mt-6 space-y-4 text-lg md:text-xl leading-relaxed text-gray-800">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong>Полная база данных</strong> по деревьям и кустарникам на территориях учреждений г.
                    Краснодар и г. Брянск с фотофиксацией и атрибутикой.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-2 inline-block w-2 h-2 rounded-full bg-[#029cda] flex-none shrink-0" />
                  <span>
                    <strong>Выявлены аварийные деревья</strong> и подготовлены адресные рекомендации по устранению
                    рисков (удаление/санитарная обрезка/лечение).
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-2 inline-block w-2 h-2 rounded-full bg-[#029cda] flex-none shrink-0" />
                  <span>
                    <strong>Повышена безопасность территорий</strong> за счёт регламента мониторинга и ухода за
                    насаждениями.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-2 inline-block w-2 h-2 rounded-full bg-[#029cda] flex-none shrink-0" />
                  <span>
                    <strong>Оптимизированы затраты</strong> благодаря раннему выявлению проблем и планированию работ.
                  </span>
                </li>
              </ul>
            </section>
          ...
          <aside className="lg:pl-2">
            <div className="bg-white rounded-3xl p-6 md:p-8 sticky top-6">
              ...
              <nav className="mt-4 space-y-3 text-gray-800">
                ...
                <a href="#result14" className="block hover:text-[#029cda] text-base md:text-lg transition-colors">
                  Результаты
                </a>
              </nav>
