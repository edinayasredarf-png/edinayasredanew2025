...
const Case3Inner: React.FC = () => {
  ...
  const caseData = {
    ...
    subtitle: 'г. Карабиха, Ярославская область',
    client: 'Администрация г. Карабиха',
    date: '2024',
    ...
    testimonial: {
      ...
      author: 'Администрация г. Карабиха',
      position: 'Ярославской области',
    },
  };

  // Превьюшки для блока "Читайте ещё"
  const caseImages = [
    '/img/cases/case1.png',
    '/img/cases/case2.png',
    '/img/cases/case3.png',
  ...
  // Вариант 2 — три фото (решение)
  const solutionImages: GalleryItem[] = [
    { src: '/img/cases/case3-1.jpg', alt: 'Волонтеры за работой' },
    { src: '/img/cases/case3-2.jpg', alt: 'Мобильное приложение для сбора данных' },
    { src: '/img/cases/case3-3.jpg', alt: 'Результаты оцифровки' },
  ];
        ...
        <div className="max-w-[1480px] mx-auto px-5 md:px-8 py-10 md:py-16">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            <div className="lg:col-span-7">
              ...
              <h1 className="mt-6 text-3xl md:text-5xl lg:text-6xl font-medium leading-tight">{caseData.title}</h1>
          ...
          <article className="space-y-10">
            ...
            <section id="task">
              ...
              <p className="mt-4 text-lg md:text-xl leading-relaxed text-gray-800">
                Клиент искал комплексное решение по инвентаризации и оцифровке мест захоронений с привлечением волонтёров: организовать набор и обучение, выстроить сбор и систематизацию данных, перевести всё в цифровой формат и сохранить историческую память.
              </p>
            ...
            <section id="solution">
              ...
              <p className="mt-4 text-lg md:text-xl leading-relaxed text-gray-800">
                Внедрили АИС «Единая Среда» и подготовили 120 рабочих мест под мобильное приложение для массового сбора данных. Провели многоступенчатое обучение волонтёрских групп, назначили кураторов и выстроили контроль качества.
              </p>
              <p className="mt-4 text-lg md:text-xl leading-relaxed text-gray-800">
                Команда помогала загружать данные и сопровождала процесс на всех этапах: от полевых работ до интеграции в единую базу и отображения на ГИС‑карте.
              </p>
            ...
            <section id="result3">
              ...
              <ul className="mt-6 space-y-4 text-lg md:text-xl leading-relaxed text-gray-800">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong>Экономия свыше 2 000 000 ₽</strong> — за счёт оптимизации процессов, автоматизации и вовлечения волонтёров.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-2 inline-block w-2 h-2 rounded-full bg-[#0077FF] flex-none shrink-0" />
                  <span>
                    <strong>Единая цифровая база</strong> — структурированные данные по всем захоронениям для планирования и обслуживания.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-2 inline-block w-2 h-2 rounded-full bg-[#0077FF] flex-none shrink-0" />
                  <span>
                    <strong>Прозрачность и доступность</strong> — оцифрованные сведения доступны службам и гражданам, способствуя сохранению исторической памяти.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-2 inline-block w-2 h-2 rounded-full bg-[#0077FF] flex-none shrink-0" />
                  <span>
                    <strong>Снижение затрат на обслуживание</strong> — автоматизация учёта и работ по содержанию.
                  </span>
                </li>
              </ul>
            </section>
          ...
          <aside className="lg:pl-2">
            <div className="bg-white rounded-3xl p-6 md:p-8 sticky top-6">
              ...
              <nav className="mt-4 space-y-3 text-gray-800">
                ...
                <a href="#result3" className="block hover:text-[#0077FF] text-base md:text-lg transition-colors">Результат для клиента</a>
              </nav>
