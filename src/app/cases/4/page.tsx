...
const Case4Inner: React.FC = () => {
  ...
  const caseData = {
    id: 4,
    title:
      'Перевели память в цифру: инвентаризация кладбищ для будущих поколений',
    subtitle:
      'Инвентаризация и оцифровка мест захоронений с экономией бюджета и обучением персонала',
    client: 'Администрация г. Корсаков, Сахалинская область',
    date: '2024',
    location: 'г. Корсаков, Сахалинская область',
    application: 'Инвентаризация мест захоронений',
    heroImg: '/img/cases/case4/case4_hero.png',
    testimonial: {
      text:
        'Благодаря проекту мы смогли сэкономить более 2,3 миллиона рублей и получили полную базу данных мест захоронений. Особенно ценно то, что наши сотрудники научились работать самостоятельно и смогли проинвентаризировать оставшиеся 23 гектара.',
      author: 'Администрация г. Корсаков',
  ...
  const singleImage: GalleryItem = {
    src: '/img/cases/case4/case4.png',
    alt: 'Полевые работы по инвентаризации в г. Корсаков',
  };

  // Серия изображений (секция «Решение»)
  const solutionImages: GalleryItem[] = [
    { src: '/img/cases/case4-1.jpg', alt: 'Полевой сбор данных' },
    { src: '/img/cases/case4-2.jpg', alt: 'Работа в мобильном приложении' },
    { src: '/img/cases/case4-3.jpg', alt: 'Отображение данных на ГИС‑карте' },
  ];
          ...
          <article className="space-y-10">
            ...
            <section id="task">
              ...
              <p className="mt-4 text-lg md:text-xl leading-relaxed text-gray-800">
                Муниципалитету требовалось провести инвентаризацию и оцифровку мест захоронений: 10 гектаров выполняли мы, ещё 23 гектара — силами администрации после обучения. Задачи включали систематизацию данных по каждому захоронению и перевод информации в централизованную цифровую базу с целью оптимизации затрат и повышения прозрачности.
              </p>
            ...
            <section id="solution">
              ...
              <p className="mt-4 text-lg md:text-xl leading-relaxed text-gray-800">
                Внедрили АИС «Единая Среда», подготовили рабочие места и мобильное приложение для полевого сбора данных. Провели многоступенчатое обучение сотрудников, назначили кураторов и выстроили контроль качества данных.
              </p>
              <p className="mt-4 text-lg md:text-xl leading-relaxed text-gray-800">
                Обеспечили загрузку и интеграцию собранной информации в единую систему с отображением на ГИС‑карте. На всех этапах проекта оказывали техническое сопровождение и поддержку.
              </p>
