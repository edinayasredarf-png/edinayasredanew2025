...
const Case7Inner: React.FC = () => {
  ...
  const caseData = {
    ...
    subtitle: 'с.п. Ряженское, Ростовская область',
    client: 'Администрация с.п. Ряженское',
    date: '2024',
    ...
    testimonial: {
      ...
      author: 'Администрация с.п. Ряженское',
      position: 'Ростовской области',
    },
  };
  ...
  const solutionImages: GalleryItem[] = [
    { src: '/img/cases/case7-1.jpg', alt: 'Инвентаризация кладбищ' },
    { src: '/img/cases/case7-2.jpg', alt: 'Цифровая база данных — интерфейс' },
    { src: '/img/cases/case7-3.jpg', alt: 'Результаты оцифровки 14 кладбищ' },
  ];
          ...
          <article className="space-y-10">
            ...
            <section id="task">
              ...
              <p className="mt-4 text-lg md:text-xl leading-relaxed text-gray-800">
                Администрации требовалось выполнить полную инвентаризацию и оцифровку{' '}
                <strong>всех 14 муниципальных кладбищ</strong> в строгом соответствии с федеральным
                законодательством (Распоряжение Правительства РФ №2424-р от 02.09.2021): сформировать единую базу
                данных, обеспечить атрибутивное заполнение и доступ к сведениям через карту.
              </p>
            ...
            <section id="solution">
              ...
              <p className="mt-4 text-lg md:text-xl leading-relaxed text-gray-800">
                Применили АИС «Единая Среда» и выполнили полный цикл работ: полевые обследования, сбор координат и
                атрибутов, проверку качества и загрузку в единый реестр с визуализацией на интерактивной ГИС-карте.
              </p>
              <p className="mt-4 text-lg md:text-xl leading-relaxed text-gray-800">
                Процессы выстроены с учётом норм и регламентов — обеспечено <strong>100% соответствие</strong>{' '}
                федеральным требованиям по учёту мест захоронений.
              </p>
            ...
            <section id="result7">
              ...
              <ul className="mt-6 space-y-4 text-lg md:text-xl leading-relaxed text-gray-800">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong>Единый цифровой реестр</strong> — оцифрованы все 14 кладбищ, данные доступны через карту
                    и централизованную БД.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-2 inline-block w-2 h-2 rounded-full bg-[#029cda] flex-none shrink-0" />
                  <span>
                    <strong>Соответствие 2424-р</strong> — выполнены требования федерального законодательства и
                    регламентов учёта.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-2 inline-block w-2 h-2 rounded-full bg-[#029cda] flex-none shrink-0" />
                  <span>
                    <strong>Упрощённое управление</strong> — быстрый доступ к сведениям для планирования,
          ...
          <aside className="lg:pl-2">
            <div className="bg-white rounded-3xl p-6 md:p-8 sticky top-6">
              ...
              <nav className="mt-4 space-y-3 text-gray-800">
                ...
                <a href="#result7" className="block hover:text-[#029cda] text-base md:text-lg transition-colors">
