...
const Case1Inner: React.FC = () => {
  ...
  const caseData = {
    id: 1,
    title: "Цифровая трансформация управления территорией",
    subtitle: "Комплексное решение для муниципального управления",
    client: "Богучанское сельское поселение",
    date: "2024",
    location: "Красноясркий край",
    application: "Цифровая трансформация",
    heroImg: "/img/cases/case1/case1_hero.png",
    testimonial: {
      text:
        "Внедрение системы «Единая Среда» кардинально изменило наш подход к управлению территорией. Мы получили современный инструмент, который позволил повысить эффективность работы и качество предоставляемых услуг населению.",
      author: "Руководство муниципального образования",
  ...
  const singleImage: GalleryItem = {
    src: "/img/cases/case1/case1.webp",
    alt: "Снимок рабочего процесса инвентаризации",
  };

  // Вариант 2: серия из 3 фото
  const solutionImages: GalleryItem[] = [
    { src: "/img/cases/case1-1.jpg", alt: "Этап 1 — сбор данных" },
    { src: "/img/cases/case1-2.jpg", alt: "Этап 2 — обработка и верификация" },
    { src: "/img/cases/case1-3.jpg", alt: "Этап 3 — визуализация и отчётность" },
  ];
          ...
          <article className="space-y-10">
            ...
            <section id="task">
              ...
              <p className="mt-4 text-lg md:text-xl leading-relaxed text-gray-800">
                Клиент обратился с задачей провести инвентаризацию мест захоронений, расположенных на территории муниципалитета.
              </p>
            ...
            <section id="solution">
              ...
              <p className="mt-4 text-lg md:text-xl leading-relaxed text-gray-800">
                Наша компания внедрила автоматизированную информационную систему (АИС) «Единая Среда», которая оптимизировала процесс инвентаризации мест захоронений.
              </p>
          ...
          <aside className="lg:pl-2">
            <div className="bg-white rounded-3xl p-6 md:p-8 sticky top-6">
              ...
              <nav className="mt-4 space-y-3 text-gray-800">
                ...
                <a href="#result1" className="block hover:text-[#0077FF] text-base md:text-lg transition-colors">Результат для клиента</a>
              </nav>
          ...
          {related.map((m) => (
            ...
            >
              <div className="w-full h-64 rounded-xl bg-[#F6F7F9] overflow-hidden flex items-center justify-center">
                <img
                  src={caseImages[m.id - 1] || caseImages[0]}
                  alt={m.title}
                  className="w-full h-auto object-cover"
                />
              </div>
              <div className="mt-5 text-sm text-gray-500">{m.industry}</div>
              <div className="mt-2 text-xl md:text-2xl text-[#313131] leading-snug">
                {m.title}
              </div>
