...
const Case11Inner: React.FC = () => {
  ...
  const caseData = {
    id: 11,
    title: 'Инвентаризация и оцифровка зеленых насаждений с привлечением волонтеров',
    subtitle: 'г. Ярославль, Ярославская область',
    client: 'Администрация г. Ярославль',
    date: '2024',
    ...
    testimonial: {
      ...
      author: 'Администрация г. Ярославль',
      position: 'Ярославская область',
    },
  };
  ...
  const solutionImages: GalleryItem[] = [
    { src: '/img/cases/case11/case11-1.jpg', alt: 'Запуск волонтёрской программы и обучение' },
    { src: '/img/cases/case11/case11-2.jpg', alt: 'Сбор данных в мобильном приложении' },
    { src: '/img/cases/case11/case11-3.jpg', alt: 'Верификация и публикация в едином реестре' },
  ];
          ...
          <article className="space-y-10">
            ...
            <section id="task">
              ...
              <p className="mt-4 text-lg md:text-xl leading-relaxed text-gray-800">
                Провести инвентаризацию и оцифровку зелёных насаждений на территории города{' '}
                <strong>с привлечением волонтёров</strong>. Требовалось организовать набор и обучение команды,
                обеспечить сбор атрибутов (порода, возраст, диаметр, высота, состояние), а также
                централизованное накопление данных в единой системе.
              </p>
            ...
            <section id="solution">
              ...
              <p className="mt-4 text-lg md:text-xl leading-relaxed text-gray-800">
                Развернули АИС «Единая Среда», запустили волонтёрскую программу и выстроили процесс: обучение → сбор
                данных в мобильном приложении → модерация и верификация → публикация в едином реестре с ГИС-визуализацией.
              </p>
              ...
              <ul className="mt-6 space-y-4 text-lg md:text-xl leading-relaxed text-gray-800">
                <li className="flex items-start gap-3">
                  ...
                  <span><strong>Набор и обучение волонтёров</strong> — офлайн/онлайн сессии, методички, чек-листы полевых работ.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-2 inline-block w-2 h-2 rounded-full bg-[#029cda]" />
                  <span><strong>Мобильное приложение</strong> — сбор координат, фото и атрибутов каждого дерева/кустарника.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-2 inline-block w-2 h-2 rounded-full bg-[#029cda]" />
                  <span><strong>Контроль качества</strong> — модерация, автоматические проверки, дубли/аномалии, SLA-реакции.</span>
                </li>
              </ul>
            </section>
            ...
            <section id="result11">
              ...
              <ul className="mt-6 space-y-4 text-lg md:text-xl leading-relaxed text-gray-800">
                <li className="flex items-start gap-3">
                  ...
                  <span><strong>Единый цифровой реестр насаждений</strong> с ГИС-визуализацией и доступом для служб города.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-2 inline-block w-2 h-2 rounded-full bg-[#029cda] flex-none shrink-0" />
                  <span><strong>Экономия бюджета</strong> за счёт привлечения волонтёров и автоматизации рабочих процессов.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-2 inline-block w-2 h-2 rounded-full bg-[#029cda] flex-none shrink-0" />
                  <span><strong>{caseData.budget}</strong> на благоустройство и развитие городской зелёной инфраструктуры.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-2 inline-block w-2 h-2 rounded-full bg-[#029cda] flex-none shrink-0" />
                  <span><strong>Контроль подрядчиков</strong> — прозрачные KPI и мониторинг качества выполняемых работ.</span>
                </li>
              </ul>
            </section>
          ...
          <aside className="lg:pl-2">
            <div className="bg-white rounded-3xl p-6 md:p-8 sticky top-6">
              ...
              <nav className="mt-4 space-y-3 text-gray-800">
                ...
                <a href="#result11" className="block hover:text-[#029cda] text-base md:text-lg transition-colors">
                  Результаты
                </a>
              </nav>
