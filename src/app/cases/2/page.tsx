...
const Case2Inner: React.FC = () => {
  ...
  const caseData = {
    ...
    subtitle: 'х. Ленина, Аксайский район, Ростовская область',
    client:
      'Администрация Ленинского сельского поселения Аксайского района Ростовской области',
    date: '2024',
    location: 'х. Ленина, Аксайский район, Ростовская область',
    application: 'Инвентаризация мест захоронений',
    heroImg: '/img/cases/case2/case2_hero.png',
    testimonial: {
      text:
        'Благодаря проекту мы получили современную систему управления местами захоронений, которая значительно упростила нашу работу и повысила качество обслуживания населения. Система полностью соответствует требованиям законодательства.',
      author: 'Администрация Ленинского сельского поселения',
      position: 'Аксайского района Ростовской области',
    },
  };

  // изображение для секции «Задача» (одно фото)
  const singleImage: GalleryItem = {
    src: '/img/cases/case2/case2.png',
    alt: 'Инвентаризация мест захоронений — полевые работы',
  };

  // изображения для секции «Решение» (три фото)
  const solutionImages: GalleryItem[] = [
    { src: '/img/cases/case2-1.jpg', alt: 'Полевые работы по инвентаризации' },
    { src: '/img/cases/case2-2.jpg', alt: 'Интерфейс цифровой базы данных' },
    { src: '/img/cases/case2-3.jpg', alt: 'Результаты оцифровки кладбища' },
  ];

  // превью для блока «Читайте ещё» (синхронизировано с кейсом 1)
  const caseImages = [
    '/img/cases/case1.png',
    '/img/cases/case2.png',
    '/img/cases/case3.png',
          ...
          <article className="space-y-10">
            ...
            <section id="task">
              ...
              <p className="mt-4 text-lg md:text-xl leading-relaxed text-gray-800">
                Клиент обратился с задачей проведения полной инвентаризации мест захоронений на территории муниципалитета. Цель — создать точный и актуальный реестр всех захоронений для эффективного управления кладбищами, планирования использования участков и их обслуживания.
              </p>
              <p className="mt-4 text-lg md:text-xl leading-relaxed text-gray-800">
                Важным требованием были прозрачность и точность учёта, предотвращение дублирования и пропусков, а также оптимизация процессов взаимодействия между ведомствами, отвечающими за содержание кладбищ.
              </p>
            ...
            <section id="solution">
              ...
              <p className="mt-4 text-lg md:text-xl leading-relaxed text-gray-800">
                Мы внедрили автоматизированную информационную систему (АИС) «Единая Среда», провели полную инвентаризацию всех кладбищ и внесли точные данные о каждом захоронении. Все объекты отображены на интерактивной ГИС‑карте, что позволило визуально отслеживать текущее состояние кладбищ и их границы.
              </p>
              <p className="mt-4 text-lg md:text-xl leading-relaxed text-gray-800">
                Заполнена расширенная атрибутивная информация и распланированы свободные территории с учётом зонирования, кварталов и дорожной сети — это обеспечило инструменты для дальнейшего рационального использования земельных участков.
              </p>
            ...
            <section id="result2">
              ...
              <ul className="mt-6 space-y-4 text-lg md:text-xl leading-relaxed text-gray-800">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong>Полный и актуальный цифровой реестр кладбищ</strong> — вся информация о захоронениях на территории муниципалитета собрана в единую систему.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-2 inline-block w-2 h-2 rounded-full bg-[#029cda] flex-none shrink-0" />
                  <span>
                    <strong>Детализированные данные о будущих местах захоронений</strong> — распланированные участки с учётом зонирования, кварталов и дорожных сетей.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-2 inline-block w-2 h-2 rounded-full bg-[#029cda] flex-none shrink-0" />
                  <span>
                    <strong>Рациональное использование земель</strong> — благодаря детальному планированию новые захоронения размещаются оптимально.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-2 inline-block w-2 h-2 rounded-full bg-[#029cda] flex-none shrink-0" />
                  <span>
                    <strong>Соответствие законодательству</strong> — выполнены требования Распоряжения Правительства РФ № 2424‑р от 02.09.2021.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-2 inline-block w-2 h-2 rounded-full bg-[#029cda] flex-none shrink-0" />
                  <span>
                    <strong>Удобное планирование и управление</strong> — интерактивные карты и структурированные данные обеспечивают быстрый доступ к информации.
                  </span>
                </li>
              </ul>
            </section>
          ...
          <aside className="lg:pl-2">
            <div className="bg-white rounded-3xl p-6 md:p-8 sticky top-6">
              ...
              <nav className="mt-4 space-y-3 text-gray-800">
                <a
                  href="#task"
                  className="block hover:text-[#029cda] text-base md:text-lg transition-colors"
                >
                  Задача клиента
                </a>
                <a
