...
const Case5Inner: React.FC = () => {
  ...
  const caseData = {
    ...
    subtitle: 'г. Киров, Калужская область',
    client: 'Администрация г. Киров',
    date: '2024',
    ...
    testimonial: {
      ...
      author: 'Администрация г. Киров',
      position: 'Калужской области',
    },
  };
  ...
  const solutionImages: GalleryItem[] = [
    { src: '/img/cases/case5-1.jpg', alt: 'Инвентаризация кладбищ' },
    { src: '/img/cases/case5-2.jpg', alt: 'Цифровая база данных — интерфейс' },
    { src: '/img/cases/case5-3.jpg', alt: 'Результаты оцифровки' },
  ];
          ...
          <article className="space-y-10">
            ...
            <section id="task">
              ...
              <p className="mt-4 text-lg md:text-xl leading-relaxed text-gray-800">
                Администрации требовалось провести инвентаризацию и оцифровку мест захоронений на шести муниципальных кладбищах собственными силами: оптимизировать бюджет, собрать и систематизировать данные по каждому захоронению и сформировать актуальный цифровой реестр.
              </p>
            ...
            <section id="solution">
              ...
              <p className="mt-4 text-lg md:text-xl leading-relaxed text-gray-800">
                Предоставили доступ к АИС «Единая Среда» для самостоятельной инвентаризации, настроили мобильное приложение и организовали процесс сбора и хранения данных в единой системе.
              </p>
              <p className="mt-4 text-lg md:text-xl leading-relaxed text-gray-800">
                Провели инструктаж, обучение сотрудников и обеспечили техническое сопровождение на всех этапах: от полевых работ до интеграции данных и проверки качества.
              </p>
            ...
            <section id="result5">
              ...
              <ul className="mt-6 space-y-4 text-lg md:text-xl leading-relaxed text-gray-800">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong>Сокращение бюджетных расходов</strong> — вместо подрядчиков приобретён доступ к системе и организована самостоятельная инвентаризация.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-2 inline-block w-2 h-2 rounded-full bg-[#0077FF] flex-none shrink-0" />
                  <span>
                    <strong>Актуальный цифровой реестр</strong> — собраны и внесены данные по шести кладбищам с атрибутами и привязкой на карте.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-2 inline-block w-2 h-2 rounded-full bg-[#0077FF] flex-none shrink-0" />
                  <span>
                    <strong>Упорядоченное управление</strong> — доступ к единым данным упростил планирование и обслуживание мест захоронений.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-2 inline-block w-2 h-2 rounded-full bg-[#0077FF] flex-none shrink-0" />
                  <span>
                    <strong>Экономия ~180 000 ₽</strong> — за счёт самостоятельного выполнения работ и минимизации внешних затрат.
                  </span>
                </li>
              </ul>
            </section>
          ...
          <aside className="lg:pl-2">
            <div className="bg-white rounded-3xl p-6 md:p-8 sticky top-6">
              ...
              <nav className="mt-4 space-y-3 text-gray-800">
                ...
                <a href="#result5" className="block hover:text-[#0077FF] text-base md:text-lg transition-colors">Результат для клиента</a>
              </nav>
