...
import { sb_getCaseBySlug, sb_listCases, CaseItem } from '@/lib/blogStore';
...
export default function CaseSlugPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        setLoading(true);
        const data = await sb_getCaseBySlug(slug);
        setCaseData(data || null);

        // Загружаем связанные кейсы
      ...
      <div className="bg-[#F6F7F9] min-h-screen font-[Raleway] font-medium lining-nums">
        ...
        <section className="max-w-[1480px] mx-auto px-5 md:px-8 py-10 md:py-14">
          <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_360px] gap-8">
            ...
            <article className="space-y-10">
              <section className="bg-white rounded-3xl p-6 md:p-8">
                ...
                <style jsx global>{`
                  ...
                  .article-toc-targets h2,
                  .article-toc-targets h3 { 
                ...
                {/* Редактирование/удаление для админов */}
                {isEditor && (
            ...
            {/* RIGHT - Содержание (h2/h3 из статьи с якорями) */}
