...
export const metadata: Metadata = {
	...
	description: 'Профессиональная деревьев и зелёных насаждений в Серпухове: ГИС-учёт, аналитика, паспорта объектов.  Соответствие требованиям и высокая точность.',
		...
		<>
			...
			<Script id="json-ld-software" type="application/ld+json">
				{JSON.stringify({
					...
					description: "Инвентаризация зеленых насаждений и кладбищ в Серпухове с созданием цифрового реестра. Сбор, оцифровка и аналитика данных, соответствие требованиям законодательства.",
					offers: {
						"@type": "Offer",
						price: "0",
						priceCurrency: "RUB",
