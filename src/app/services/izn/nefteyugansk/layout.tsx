...
export const metadata: Metadata = {
	title: 'Инвентаризация зеленых насаждений в Нефтеюганске под ключ с созданием цифрового реестра',
	description: 'Профессиональная инвентаризация деревьев и зелёных насаждений в Нефтеюганске: ГИС-учёт, аналитика, паспорта объектов. Соответствие требованиям и высокая точность.',
	alternates: { canonical: '/services/izn/nefteyugansk' },
	openGraph: {
		title: 'Инвентаризация зеленых насаждений в Нефтеюганске — Единая среда',
		description: 'Полный учёт зелёных зон в Нефтеюганске: координаты, атрибуты, аналитика в ГИС.',
		url: '/services/izn/nefteyugansk',
		type: 'article',
	...
	twitter: {
		...
		title: 'Инвентаризация зеленых насаждений в Нефтеюганске Единая среда',
		description: 'Профессиональная инвентаризация зеленых насаждений в Нефтеюганске: точные данные и аналитика.',
		...
		<>
			...
			<Script id="json-ld-software" type="application/ld+json">
				{JSON.stringify({
					...
					operatingSystem: "Web",
					url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/izn/nefteyugansk",
					screenshot: "https://xn--80aakbcct4b2aj7m.xn--p1ai/img/услуга_изн.png",
					description: "Инвентаризация зеленых насаждений в Нефтеюганске с созданием цифрового реестра. Сбор, оцифровка и аналитика данных, соответствие требованиям законодательства.",
					offers: {
						"@type": "Offer",
						price: "0",
						priceCurrency: "RUB",
