...
export const metadata: Metadata = {
	title: 'Инвентаризация зеленых насаждений в Стерлитамаке под ключ с созданием цифрового реестра',
	description: 'Профессиональная инвентаризация деревьев и зелёных насаждений в Стерлитамаке: ГИС-учёт, аналитика, паспорта объектов. Соответствие требованиям и высокая точность.',
	alternates: { canonical: '/services/izn/sterlitamak' },
	openGraph: {
		title: 'Инвентаризация зеленых насаждений в Стерлитамаке — Единая среда',
		description: 'Полный учёт зелёных зон в Стерлитамаке: координаты, атрибуты, аналитика в ГИС.',
		url: '/services/izn/sterlitamak',
		type: 'article',
	...
	twitter: {
		...
		title: 'Инвентаризация зеленых насаждений в Стерлитамаке Единая среда',
		description: 'Профессиональная инвентаризация зеленых насаждений в Стерлитамаке: точные данные и аналитика.',
		...
		<>
			...
			<Script id="json-ld-software" type="application/ld+json">
				{JSON.stringify({
					...
					operatingSystem: "Web",
					url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/izn/sterlitamak",
					screenshot: "https://xn--80aakbcct4b2aj7m.xn--p1ai/img/услуга_изн.png",
					description: "Инвентаризация зеленых насаждений в Стерлитамаке с созданием цифрового реестра. Сбор, оцифровка и аналитика данных, соответствие требованиям законодательства.",
					offers: {
						"@type": "Offer",
						price: "0",
						priceCurrency: "RUB",
