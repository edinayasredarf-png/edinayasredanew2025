...
export const metadata: Metadata = {
	...
	description: 'Профессиональная деревьев и зелёных насаждений в Новом Уренгое: ГИС-учёт, аналитика, паспорта объектов.  Соответствие требованиям и высокая точность.',
	alternates: { canonical: '/services/izn' },
	openGraph: {
		title: 'Инвентаризация зеленых насаждений в Новом Уренгое — Единая среда',
		description: 'Полный учёт зелёных зон в Новом Уренгое: координаты, атрибуты, аналитика в ГИС.',
		url: '/services/izn',
		type: 'article',
	...
	twitter: {
		...
		title: 'Инвентаризация зеленых насаждений в Новом Уренгое Единая среда',
		description: 'Профессиональная инвентаризация кладбищ в Новом Уренгое: точные данные и аналитика.',
		...
		<>
			...
			<Script id="json-ld-software" type="application/ld+json">
				{JSON.stringify({
					...
					description: "Инвентаризация зеленых насаждений и кладбищ в Новом Уренгое с созданием цифрового реестра. Сбор, оцифровка и аналитика данных, соответствие требованиям законодательства.",
					offers: {
						"@type": "Offer",
						price: "0",
						priceCurrency: "RUB",
