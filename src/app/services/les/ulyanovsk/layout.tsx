...
export const metadata: Metadata = {
  title: 'Лесоустройство в Ульяновске под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Ульяновске: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/ulyanovsk' },
  openGraph: {
    title: 'Лесоустройство в Ульяновске — Единая среда',
    description: 'Комплексное лесоустройство в Ульяновске: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/ulyanovsk',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Ульяновске — Единая среда',
    description: 'Профессиональное лесоустройство в Ульяновске: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Ульяновск" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/ulyanovsk",
          description: "Лесоустройство в Ульяновске: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
