...
export const metadata: Metadata = {
  title: 'Лесоустройство в Архангельске под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Архангельске: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/arhangelsk' },
  openGraph: {
    title: 'Лесоустройство в Архангельске — Единая среда',
    description: 'Комплексное лесоустройство в Архангельске: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/arhangelsk',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Архангельске — Единая среда',
    description: 'Профессиональное лесоустройство в Архангельске: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Архангельск" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/arhangelsk",
          description: "Лесоустройство в Архангельске: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
