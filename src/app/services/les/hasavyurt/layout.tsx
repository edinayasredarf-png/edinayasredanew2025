...
export const metadata: Metadata = {
  title: 'Лесоустройство в Хасавюрте под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Хасавюрте: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/hasavyurt' },
  openGraph: {
    title: 'Лесоустройство в Хасавюрте — Единая среда',
    description: 'Комплексное лесоустройство в Хасавюрте: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/hasavyurt',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Хасавюрте — Единая среда',
    description: 'Профессиональное лесоустройство в Хасавюрте: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Хасавюрт" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/hasavyurt",
          description: "Лесоустройство в Хасавюрте: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
