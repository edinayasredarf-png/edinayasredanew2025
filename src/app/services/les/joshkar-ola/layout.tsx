...
export const metadata: Metadata = {
  title: 'Лесоустройство в Йошкар-Оле под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Йошкар-Оле: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/joshkar-ola' },
  openGraph: {
    title: 'Лесоустройство в Йошкар-Оле — Единая среда',
    description: 'Комплексное лесоустройство в Йошкар-Оле: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/joshkar-ola',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Йошкар-Оле — Единая среда',
    description: 'Профессиональное лесоустройство в Йошкар-Оле: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Йошкар-Ола" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/joshkar-ola",
          description: "Лесоустройство в Йошкар-Оле: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
