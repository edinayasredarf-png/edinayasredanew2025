...
export const metadata: Metadata = {
  title: 'Лесоустройство в Таганроге под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Таганроге: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/taganrog' },
  openGraph: {
    title: 'Лесоустройство в Таганроге — Единая среда',
    description: 'Комплексное лесоустройство в Таганроге: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/taganrog',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Таганроге — Единая среда',
    description: 'Профессиональное лесоустройство в Таганроге: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Таганрог" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/taganrog",
          description: "Лесоустройство в Таганроге: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
