...
export const metadata: Metadata = {
  title: 'Лесоустройство в Новом Уренгое под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Новом Уренгое: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/novyj-urengoj' },
  openGraph: {
    title: 'Лесоустройство в Новом Уренгое — Единая среда',
    description: 'Комплексное лесоустройство в Новом Уренгое: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/novyj-urengoj',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Новом Уренгое — Единая среда',
    description: 'Профессиональное лесоустройство в Новом Уренгое: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Новый Уренгой" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/novyj-urengoj",
          description: "Лесоустройство в Новом Уренгое: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
