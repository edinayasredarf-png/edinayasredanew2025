...
export const metadata: Metadata = {
  title: 'Лесоустройство в Сыктывкаре под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Сыктывкаре: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/syktyvkar' },
  openGraph: {
    title: 'Лесоустройство в Сыктывкаре — Единая среда',
    description: 'Комплексное лесоустройство в Сыктывкаре: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/syktyvkar',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Сыктывкаре — Единая среда',
    description: 'Профессиональное лесоустройство в Сыктывкаре: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Сыктывкар" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/syktyvkar",
          description: "Лесоустройство в Сыктывкаре: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
