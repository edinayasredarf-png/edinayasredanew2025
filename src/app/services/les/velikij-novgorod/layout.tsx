...
export const metadata: Metadata = {
  title: 'Лесоустройство в Великом Новгороде под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Великом Новгороде: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/velikij-novgorod' },
  openGraph: {
    title: 'Лесоустройство в Великом Новгороде — Единая среда',
    description: 'Комплексное лесоустройство в Великом Новгороде: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/velikij-novgorod',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Великом Новгороде — Единая среда',
    description: 'Профессиональное лесоустройство в Великом Новгороде: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/velikij-novgorod",
          description: "Лесоустройство в Великом Новгороде: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
