...
export const metadata: Metadata = {
  title: 'Лесоустройство в Нижнем Тагиле под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Нижнем Тагиле: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/nizhnij-tagil' },
  openGraph: {
    title: 'Лесоустройство в Нижнем Тагиле — Единая среда',
    description: 'Комплексное лесоустройство в Нижнем Тагиле: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/nizhnij-tagil',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Нижнем Тагиле — Единая среда',
    description: 'Профессиональное лесоустройство в Нижнем Тагиле: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Нижний Тагил" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/nizhnij-tagil",
          description: "Лесоустройство в Нижнем Тагиле: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
