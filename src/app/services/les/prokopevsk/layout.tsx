...
export const metadata: Metadata = {
  title: 'Лесоустройство в Прокопьевске под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Прокопьевске: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/prokopevsk' },
  openGraph: {
    title: 'Лесоустройство в Прокопьевске — Единая среда',
    description: 'Комплексное лесоустройство в Прокопьевске: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/prokopevsk',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Прокопьевске — Единая среда',
    description: 'Профессиональное лесоустройство в Прокопьевске: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Прокопьевск" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/prokopevsk",
          description: "Лесоустройство в Прокопьевске: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
