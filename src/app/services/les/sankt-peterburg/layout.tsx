...
export const metadata: Metadata = {
  title: 'Лесоустройство в Санкт-Петербурге под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Санкт-Петербурге: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/sankt-peterburg' },
  openGraph: {
    title: 'Лесоустройство в Санкт-Петербурге — Единая среда',
    description: 'Комплексное лесоустройство в Санкт-Петербурге: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/sankt-peterburg',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Санкт-Петербурге — Единая среда',
    description: 'Профессиональное лесоустройство в Санкт-Петербурге: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/sankt-peterburg",
          description: "Лесоустройство в Санкт-Петербурге: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
