...
export const metadata: Metadata = {
  title: 'Лесоустройство в Набережных Челнах под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Набережных Челнах: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/naberezhnye-chelny' },
  openGraph: {
    title: 'Лесоустройство в Набережных Челнах — Единая среда',
    description: 'Комплексное лесоустройство в Набережных Челнах: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/naberezhnye-chelny',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Набережных Челнах — Единая среда',
    description: 'Профессиональное лесоустройство в Набережных Челнах: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Набережные Челны" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/naberezhnye-chelny",
          description: "Лесоустройство в Набережных Челнах: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
