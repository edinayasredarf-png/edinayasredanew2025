...
export const metadata: Metadata = {
  title: 'Лесоустройство в Ноябрьске под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Ноябрьске: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/noyabrsk' },
  openGraph: {
    title: 'Лесоустройство в Ноябрьске — Единая среда',
    description: 'Комплексное лесоустройство в Ноябрьске: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/noyabrsk',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Ноябрьске — Единая среда',
    description: 'Профессиональное лесоустройство в Ноябрьске: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Ноябрьск" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/noyabrsk",
          description: "Лесоустройство в Ноябрьске: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
