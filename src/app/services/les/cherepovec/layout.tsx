...
export const metadata: Metadata = {
  title: 'Лесоустройство в Череповце под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Череповце: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/cherepovec' },
  openGraph: {
    title: 'Лесоустройство в Череповце — Единая среда',
    description: 'Комплексное лесоустройство в Череповце: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/cherepovec',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Череповце — Единая среда',
    description: 'Профессиональное лесоустройство в Череповце: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Череповец" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/cherepovec",
          description: "Лесоустройство в Череповце: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
