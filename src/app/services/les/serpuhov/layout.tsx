...
export const metadata: Metadata = {
  title: 'Лесоустройство в Серпухове под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Серпухове: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/serpuhov' },
  openGraph: {
    title: 'Лесоустройство в Серпухове — Единая среда',
    description: 'Комплексное лесоустройство в Серпухове: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/serpuhov',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Серпухове — Единая среда',
    description: 'Профессиональное лесоустройство в Серпухове: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Серпухов" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/serpuhov",
          description: "Лесоустройство в Серпухове: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
