...
export const metadata: Metadata = {
  title: 'Лесоустройство в Кызыле под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Кызыле: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/kyzyl' },
  openGraph: {
    title: 'Лесоустройство в Кызыле — Единая среда',
    description: 'Комплексное лесоустройство в Кызыле: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/kyzyl',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Кызыле — Единая среда',
    description: 'Профессиональное лесоустройство в Кызыле: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Кызыл" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/kyzyl",
          description: "Лесоустройство в Кызыле: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
