...
export const metadata: Metadata = {
  title: 'Лесоустройство в Домодедово под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Домодедово: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/domodedovo' },
  openGraph: {
    title: 'Лесоустройство в Домодедово — Единая среда',
    description: 'Комплексное лесоустройство в Домодедово: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/domodedovo',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Домодедово — Единая среда',
    description: 'Профессиональное лесоустройство в Домодедово: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Домодедово" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/domodedovo",
          description: "Лесоустройство в Домодедово: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
