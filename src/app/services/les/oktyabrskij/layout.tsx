...
export const metadata: Metadata = {
  title: 'Лесоустройство в Октябрьском под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Октябрьском: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/oktyabrskij' },
  openGraph: {
    title: 'Лесоустройство в Октябрьском — Единая среда',
    description: 'Комплексное лесоустройство в Октябрьском: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/oktyabrskij',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Октябрьском — Единая среда',
    description: 'Профессиональное лесоустройство в Октябрьском: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Октябрьский" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/oktyabrskij",
          description: "Лесоустройство в Октябрьском: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
