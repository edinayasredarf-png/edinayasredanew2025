...
export const metadata: Metadata = {
  title: 'Лесоустройство в Новочеркасске под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Новочеркасске: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/novocherkassk' },
  openGraph: {
    title: 'Лесоустройство в Новочеркасске — Единая среда',
    description: 'Комплексное лесоустройство в Новочеркасске: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/novocherkassk',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Новочеркасске — Единая среда',
    description: 'Профессиональное лесоустройство в Новочеркасске: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Новочеркасск" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/novocherkassk",
          description: "Лесоустройство в Новочеркасске: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
