...
export const metadata: Metadata = {
  title: 'Лесоустройство в Комсомольске-на-Амуре под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Комсомольске-на-Амуре: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/komsomolsk-na-amure' },
  openGraph: {
    title: 'Лесоустройство в Комсомольске-на-Амуре — Единая среда',
    description: 'Комплексное лесоустройство в Комсомольске-на-Амуре: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/komsomolsk-na-amure',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Комсомольске-на-Амуре — Единая среда',
    description: 'Профессиональное лесоустройство в Комсомольске-на-Амуре: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Комсомольск-на-Амуре" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/komsomolsk-na-amure",
          description: "Лесоустройство в Комсомольске-на-Амуре: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
