...
export const metadata: Metadata = {
  title: 'Лесоустройство в Димитровграде под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Димитровграде: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/dimitrovgrad' },
  openGraph: {
    title: 'Лесоустройство в Димитровграде — Единая среда',
    description: 'Комплексное лесоустройство в Димитровграде: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/dimitrovgrad',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Димитровграде — Единая среда',
    description: 'Профессиональное лесоустройство в Димитровграде: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Димитровград" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/dimitrovgrad",
          description: "Лесоустройство в Димитровграде: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
