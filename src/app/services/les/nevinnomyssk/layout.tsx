...
export const metadata: Metadata = {
  title: 'Лесоустройство в Невинномысске под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Невинномысске: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/nevinnomyssk' },
  openGraph: {
    title: 'Лесоустройство в Невинномысске — Единая среда',
    description: 'Комплексное лесоустройство в Невинномысске: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/nevinnomyssk',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Невинномысске — Единая среда',
    description: 'Профессиональное лесоустройство в Невинномысске: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Невинномысск" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/nevinnomyssk",
          description: "Лесоустройство в Невинномысске: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
