...
export const metadata: Metadata = {
  title: 'Лесоустройство в Орехово-Зуево под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Орехово-Зуево: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/orekhovo-zuevo' },
  openGraph: {
    title: 'Лесоустройство в Орехово-Зуево — Единая среда',
    description: 'Комплексное лесоустройство в Орехово-Зуево: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/orekhovo-zuevo',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Орехово-Зуево — Единая среда',
    description: 'Профессиональное лесоустройство в Орехово-Зуево: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Орехово-Зуево" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/orekhovo-zuevo",
          description: "Лесоустройство в Орехово-Зуево: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
