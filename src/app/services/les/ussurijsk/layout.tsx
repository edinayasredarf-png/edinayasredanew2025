...
export const metadata: Metadata = {
  title: 'Лесоустройство в Уссурийске под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Уссурийске: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/ussurijsk' },
  openGraph: {
    title: 'Лесоустройство в Уссурийске — Единая среда',
    description: 'Комплексное лесоустройство в Уссурийске: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/ussurijsk',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Уссурийске — Единая среда',
    description: 'Профессиональное лесоустройство в Уссурийске: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Уссурийск" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/ussurijsk",
          description: "Лесоустройство в Уссурийске: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
