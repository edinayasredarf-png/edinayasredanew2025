...
export const metadata: Metadata = {
  title: 'Лесоустройство в Петрозаводске под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Петрозаводске: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/petrozavodsk' },
  openGraph: {
    title: 'Лесоустройство в Петрозаводске — Единая среда',
    description: 'Комплексное лесоустройство в Петрозаводске: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/petrozavodsk',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Петрозаводске — Единая среда',
    description: 'Профессиональное лесоустройство в Петрозаводске: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Петрозаводск" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/petrozavodsk",
          description: "Лесоустройство в Петрозаводске: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
