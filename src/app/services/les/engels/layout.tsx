...
export const metadata: Metadata = {
  title: 'Лесоустройство в Энгельсе под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Энгельсе: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/engels' },
  openGraph: {
    title: 'Лесоустройство в Энгельсе — Единая среда',
    description: 'Комплексное лесоустройство в Энгельсе: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/engels',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Энгельсе — Единая среда',
    description: 'Профессиональное лесоустройство в Энгельсе: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Энгельс" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/engels",
          description: "Лесоустройство в Энгельсе: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
