...
export const metadata: Metadata = {
  title: 'Лесоустройство в Стерлитамаке под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Стерлитамаке: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/sterlitamak' },
  openGraph: {
    title: 'Лесоустройство в Стерлитамаке — Единая среда',
    description: 'Комплексное лесоустройство в Стерлитамаке: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/sterlitamak',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Стерлитамаке — Единая среда',
    description: 'Профессиональное лесоустройство в Стерлитамаке: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Стерлитамак" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/sterlitamak",
          description: "Лесоустройство в Стерлитамаке: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
