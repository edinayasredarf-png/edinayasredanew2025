...
export const metadata: Metadata = {
  title: 'Лесоустройство в Новокузнецке под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Новокузнецке: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/novokuzneck' },
  openGraph: {
    title: 'Лесоустройство в Новокузнецке — Единая среда',
    description: 'Комплексное лесоустройство в Новокузнецке: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/novokuzneck',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Новокузнецке — Единая среда',
    description: 'Профессиональное лесоустройство в Новокузнецке: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Новокузнецк" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/novokuzneck",
          description: "Лесоустройство в Новокузнецке: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
