...
export const metadata: Metadata = {
  title: 'Лесоустройство в Копейске под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Копейске: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/kopejsk' },
  openGraph: {
    title: 'Лесоустройство в Копейске — Единая среда',
    description: 'Комплексное лесоустройство в Копейске: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/kopejsk',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Копейске — Единая среда',
    description: 'Профессиональное лесоустройство в Копейске: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Копейск" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/kopejsk",
          description: "Лесоустройство в Копейске: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
