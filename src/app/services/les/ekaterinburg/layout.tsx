...
export const metadata: Metadata = {
  title: 'Лесоустройство в Екатеринбурге под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Екатеринбурге: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/ekaterinburg' },
  openGraph: {
    title: 'Лесоустройство в Екатеринбурге — Единая среда',
    description: 'Комплексное лесоустройство в Екатеринбурге: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/ekaterinburg',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Екатеринбурге — Единая среда',
    description: 'Профессиональное лесоустройство в Екатеринбурге: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/ekaterinburg",
          description: "Лесоустройство в Екатеринбурге: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
