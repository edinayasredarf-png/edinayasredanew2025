...
export const metadata: Metadata = {
  title: 'Лесоустройство в Севастополе под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Севастополе: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/sevastopol' },
  openGraph: {
    title: 'Лесоустройство в Севастополе — Единая среда',
    description: 'Комплексное лесоустройство в Севастополе: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/sevastopol',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Севастополе — Единая среда',
    description: 'Профессиональное лесоустройство в Севастополе: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Севастополь" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/sevastopol",
          description: "Лесоустройство в Севастополе: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
