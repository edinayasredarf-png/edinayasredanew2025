...
export const metadata: Metadata = {
  title: 'Лесоустройство в Калининграде под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Калининграде: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/kaliningrad' },
  openGraph: {
    title: 'Лесоустройство в Калининграде — Единая среда',
    description: 'Комплексное лесоустройство в Калининграде: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/kaliningrad',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Калининграде — Единая среда',
    description: 'Профессиональное лесоустройство в Калининграде: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
