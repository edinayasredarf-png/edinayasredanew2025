...
export const metadata: Metadata = {
  title: 'Лесоустройство в Симферополе под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Симферополе: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/simferopol' },
  openGraph: {
    title: 'Лесоустройство в Симферополе — Единая среда',
    description: 'Комплексное лесоустройство в Симферополе: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/simferopol',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Симферополе — Единая среда',
    description: 'Профессиональное лесоустройство в Симферополе: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Симферополь" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/simferopol",
          description: "Лесоустройство в Симферополе: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
