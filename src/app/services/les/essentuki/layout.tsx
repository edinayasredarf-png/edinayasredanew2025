...
export const metadata: Metadata = {
  title: 'Лесоустройство в Ессентуках под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Ессентуках: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/essentuki' },
  openGraph: {
    title: 'Лесоустройство в Ессентуках — Единая среда',
    description: 'Комплексное лесоустройство в Ессентуках: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/essentuki',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Ессентуках — Единая среда',
    description: 'Профессиональное лесоустройство в Ессентуках: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Ессентуки" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/essentuki",
          description: "Лесоустройство в Ессентуках: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
