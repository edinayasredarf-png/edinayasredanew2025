...
export const metadata: Metadata = {
  title: 'Лесоустройство в Арзамасе под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Арзамасе: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/arzamas' },
  openGraph: {
    title: 'Лесоустройство в Арзамасе — Единая среда',
    description: 'Комплексное лесоустройство в Арзамасе: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/arzamas',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Арзамасе — Единая среда',
    description: 'Профессиональное лесоустройство в Арзамасе: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Арзамас" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/arzamas",
          description: "Лесоустройство в Арзамасе: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
