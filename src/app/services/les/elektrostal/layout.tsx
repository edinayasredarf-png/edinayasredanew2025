...
export const metadata: Metadata = {
  title: 'Лесоустройство в Электростали под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Электростали: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/elektrostal' },
  openGraph: {
    title: 'Лесоустройство в Электростали — Единая среда',
    description: 'Комплексное лесоустройство в Электростали: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/elektrostal',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Электростали — Единая среда',
    description: 'Профессиональное лесоустройство в Электростали: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Электросталь" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/elektrostal",
          description: "Лесоустройство в Электростали: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
