...
export const metadata: Metadata = {
  title: 'Лесоустройство в Нефтеюганске под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Нефтеюганске: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/nefteyugansk' },
  openGraph: {
    title: 'Лесоустройство в Нефтеюганске — Единая среда',
    description: 'Комплексное лесоустройство в Нефтеюганске: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/nefteyugansk',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Нефтеюганске — Единая среда',
    description: 'Профессиональное лесоустройство в Нефтеюганске: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Нефтеюганск" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/nefteyugansk",
          description: "Лесоустройство в Нефтеюганске: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
