...
export const metadata: Metadata = {
  title: 'Лесоустройство в Красногорске под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Красногорске: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/krasnogorsk' },
  openGraph: {
    title: 'Лесоустройство в Красногорске — Единая среда',
    description: 'Комплексное лесоустройство в Красногорске: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/krasnogorsk',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Красногорске — Единая среда',
    description: 'Профессиональное лесоустройство в Красногорске: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Красногорск" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/krasnogorsk",
          description: "Лесоустройство в Красногорске: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
