...
export const metadata: Metadata = {
  title: 'Лесоустройство в Первоуральске под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Первоуральске: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/pervouralsk' },
  openGraph: {
    title: 'Лесоустройство в Первоуральске — Единая среда',
    description: 'Комплексное лесоустройство в Первоуральске: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/pervouralsk',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Первоуральске — Единая среда',
    description: 'Профессиональное лесоустройство в Первоуральске: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Первоуральск" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/pervouralsk",
          description: "Лесоустройство в Первоуральске: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
