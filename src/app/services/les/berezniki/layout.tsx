...
export const metadata: Metadata = {
  title: 'Лесоустройство в Березниках под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Березниках: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/berezniki' },
  openGraph: {
    title: 'Лесоустройство в Березниках — Единая среда',
    description: 'Комплексное лесоустройство в Березниках: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/berezniki',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Березниках — Единая среда',
    description: 'Профессиональное лесоустройство в Березниках: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Березники" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/berezniki",
          description: "Лесоустройство в Березниках: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
