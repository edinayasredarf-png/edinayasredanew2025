...
export const metadata: Metadata = {
  title: 'Лесоустройство в Ярославле под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Ярославле: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/yaroslavl' },
  openGraph: {
    title: 'Лесоустройство в Ярославле — Единая среда',
    description: 'Комплексное лесоустройство в Ярославле: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/yaroslavl',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Ярославле — Единая среда',
    description: 'Профессиональное лесоустройство в Ярославле: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Ярославль" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/yaroslavl",
          description: "Лесоустройство в Ярославле: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
