...
export const metadata: Metadata = {
  title: 'Лесоустройство в Балашихе под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Балашихе: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/balashiha' },
  openGraph: {
    title: 'Лесоустройство в Балашихе — Единая среда',
    description: 'Комплексное лесоустройство в Балашихе: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/balashiha',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Балашихе — Единая среда',
    description: 'Профессиональное лесоустройство в Балашихе: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Балашиха" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/balashiha",
          description: "Лесоустройство в Балашихе: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
