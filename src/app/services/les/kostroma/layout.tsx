...
export const metadata: Metadata = {
  title: 'Лесоустройство в Костроме под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Костроме: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/kostroma' },
  openGraph: {
    title: 'Лесоустройство в Костроме — Единая среда',
    description: 'Комплексное лесоустройство в Костроме: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/kostroma',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Костроме — Единая среда',
    description: 'Профессиональное лесоустройство в Костроме: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Кострома" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/kostroma",
          description: "Лесоустройство в Костроме: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
