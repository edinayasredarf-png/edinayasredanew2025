...
export const metadata: Metadata = {
  title: 'Лесоустройство в Каменске-Уральском под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Каменске-Уральском: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/kamensk-uralskij' },
  openGraph: {
    title: 'Лесоустройство в Каменске-Уральском — Единая среда',
    description: 'Комплексное лесоустройство в Каменске-Уральском: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/kamensk-uralskij',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Каменске-Уральском — Единая среда',
    description: 'Профессиональное лесоустройство в Каменске-Уральском: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Каменск-Уральский" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/kamensk-uralskij",
          description: "Лесоустройство в Каменске-Уральском: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
