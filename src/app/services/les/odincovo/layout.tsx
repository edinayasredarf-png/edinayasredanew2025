...
export const metadata: Metadata = {
  title: 'Лесоустройство в Одинцово под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Одинцово: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/odincovo' },
  openGraph: {
    title: 'Лесоустройство в Одинцово — Единая среда',
    description: 'Комплексное лесоустройство в Одинцово: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/odincovo',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Одинцово — Единая среда',
    description: 'Профессиональное лесоустройство в Одинцово: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Одинцово" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/odincovo",
          description: "Лесоустройство в Одинцово: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
