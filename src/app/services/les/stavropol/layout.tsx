...
export const metadata: Metadata = {
  title: 'Лесоустройство в Ставрополе под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Ставрополе: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/stavropol' },
  openGraph: {
    title: 'Лесоустройство в Ставрополе — Единая среда',
    description: 'Комплексное лесоустройство в Ставрополе: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/stavropol',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Ставрополе — Единая среда',
    description: 'Профессиональное лесоустройство в Ставрополе: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/stavropol",
          description: "Лесоустройство в Ставрополе: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
