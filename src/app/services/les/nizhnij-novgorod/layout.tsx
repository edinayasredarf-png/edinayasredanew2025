...
export const metadata: Metadata = {
  title: 'Лесоустройство в Нижнем Новгороде под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Нижнем Новгороде: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/nizhnij-novgorod' },
  openGraph: {
    title: 'Лесоустройство в Нижнем Новгороде — Единая среда',
    description: 'Комплексное лесоустройство в Нижнем Новгороде: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/nizhnij-novgorod',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Нижнем Новгороде — Единая среда',
    description: 'Профессиональное лесоустройство в Нижнем Новгороде: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/nizhnij-novgorod",
          description: "Лесоустройство в Нижнем Новгороде: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
