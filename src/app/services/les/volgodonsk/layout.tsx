...
export const metadata: Metadata = {
  title: 'Лесоустройство в Волгодонске под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Волгодонске: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/volgodonsk' },
  openGraph: {
    title: 'Лесоустройство в Волгодонске — Единая среда',
    description: 'Комплексное лесоустройство в Волгодонске: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/volgodonsk',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Волгодонске — Единая среда',
    description: 'Профессиональное лесоустройство в Волгодонске: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Волгодонск" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/volgodonsk",
          description: "Лесоустройство в Волгодонске: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
