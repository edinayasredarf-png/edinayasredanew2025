...
export const metadata: Metadata = {
  title: 'Лесоустройство в Ханты-Мансийске под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Ханты-Мансийске: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/hanty-mansijsk' },
  openGraph: {
    title: 'Лесоустройство в Ханты-Мансийске — Единая среда',
    description: 'Комплексное лесоустройство в Ханты-Мансийске: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/hanty-mansijsk',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Ханты-Мансийске — Единая среда',
    description: 'Профессиональное лесоустройство в Ханты-Мансийске: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Ханты-Мансийск" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/hanty-mansijsk",
          description: "Лесоустройство в Ханты-Мансийске: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
