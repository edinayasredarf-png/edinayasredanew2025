...
export const metadata: Metadata = {
  title: 'Лесоустройство в Чебоксарах под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Чебоксарах: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/cheboksary' },
  openGraph: {
    title: 'Лесоустройство в Чебоксарах — Единая среда',
    description: 'Комплексное лесоустройство в Чебоксарах: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/cheboksary',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Чебоксарах — Единая среда',
    description: 'Профессиональное лесоустройство в Чебоксарах: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Чебоксары" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/cheboksary",
          description: "Лесоустройство в Чебоксарах: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
