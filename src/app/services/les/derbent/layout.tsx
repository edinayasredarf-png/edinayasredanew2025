...
export const metadata: Metadata = {
  title: 'Лесоустройство в Дербенте под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Дербенте: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/derbent' },
  openGraph: {
    title: 'Лесоустройство в Дербенте — Единая среда',
    description: 'Комплексное лесоустройство в Дербенте: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/derbent',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Дербенте — Единая среда',
    description: 'Профессиональное лесоустройство в Дербенте: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Дербент" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/derbent",
          description: "Лесоустройство в Дербенте: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
