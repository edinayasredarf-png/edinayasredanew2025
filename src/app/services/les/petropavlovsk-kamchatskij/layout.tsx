...
export const metadata: Metadata = {
  title: 'Лесоустройство в Петропавловске-Камчатском под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Петропавловске-Камчатском: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/petropavlovsk-kamchatskij' },
  openGraph: {
    title: 'Лесоустройство в Петропавловске-Камчатском — Единая среда',
    description: 'Комплексное лесоустройство в Петропавловске-Камчатском: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/petropavlovsk-kamchatskij',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Петропавловске-Камчатском — Единая среда',
    description: 'Профессиональное лесоустройство в Петропавловске-Камчатском: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Петропавловск-Камчатский" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/petropavlovsk-kamchatskij",
          description: "Лесоустройство в Петропавловске-Камчатском: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
