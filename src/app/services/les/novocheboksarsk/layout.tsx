...
export const metadata: Metadata = {
  title: 'Лесоустройство в Новочебоксарске под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Новочебоксарске: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/novocheboksarsk' },
  openGraph: {
    title: 'Лесоустройство в Новочебоксарске — Единая среда',
    description: 'Комплексное лесоустройство в Новочебоксарске: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/novocheboksarsk',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Новочебоксарске — Единая среда',
    description: 'Профессиональное лесоустройство в Новочебоксарске: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Новочебоксарск" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/novocheboksarsk",
          description: "Лесоустройство в Новочебоксарске: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
