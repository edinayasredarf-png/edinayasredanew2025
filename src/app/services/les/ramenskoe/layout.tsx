...
export const metadata: Metadata = {
  title: 'Лесоустройство в Раменском под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Раменском: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/ramenskoe' },
  openGraph: {
    title: 'Лесоустройство в Раменском — Единая среда',
    description: 'Комплексное лесоустройство в Раменском: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/ramenskoe',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Раменском — Единая среда',
    description: 'Профессиональное лесоустройство в Раменском: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/ramenskoe",
          description: "Лесоустройство в Раменском: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
