...
export const metadata: Metadata = {
  title: 'Лесоустройство в Долгопрудном под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Долгопрудном: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/dolgoprudnyj' },
  openGraph: {
    title: 'Лесоустройство в Долгопрудном — Единая среда',
    description: 'Комплексное лесоустройство в Долгопрудном: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/dolgoprudnyj',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Долгопрудном — Единая среда',
    description: 'Профессиональное лесоустройство в Долгопрудном: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Долгопрудный" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/dolgoprudnyj",
          description: "Лесоустройство в Долгопрудном: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
