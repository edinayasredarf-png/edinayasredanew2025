...
export const metadata: Metadata = {
  title: 'Лесоустройство в Королёве под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Королёве: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/korolyov' },
  openGraph: {
    title: 'Лесоустройство в Королёве — Единая среда',
    description: 'Комплексное лесоустройство в Королёве: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/korolyov',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Королёве — Единая среда',
    description: 'Профессиональное лесоустройство в Королёве: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Королёв" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/korolyov",
          description: "Лесоустройство в Королёве: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
