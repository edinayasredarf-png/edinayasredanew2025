...
export const metadata: Metadata = {
  title: 'Лесоустройство в Альметьевске под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Альметьевске: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/almetevsk' },
  openGraph: {
    title: 'Лесоустройство в Альметьевске — Единая среда',
    description: 'Комплексное лесоустройство в Альметьевске: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/almetevsk',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Альметьевске — Единая среда',
    description: 'Профессиональное лесоустройство в Альметьевске: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Альметьевск" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/almetevsk",
          description: "Лесоустройство в Альметьевске: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
