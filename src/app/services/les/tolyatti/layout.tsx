...
export const metadata: Metadata = {
  title: 'Лесоустройство в Тольятти под ключ — комплексные работы',
  description: 'Профессиональное лесоустройство в Тольятти: инвентаризация лесного фонда, таксация, разработка проектов. Соответствие требованиям законодательства.',
  alternates: { canonical: '/services/les/tolyatti' },
  openGraph: {
    title: 'Лесоустройство в Тольятти — Единая среда',
    description: 'Комплексное лесоустройство в Тольятти: оценка состояния лесов, картографирование, планирование лесохозяйственных мероприятий.',
    url: '/services/les/tolyatti',
    type: 'article',
  ...
  twitter: {
    ...
    title: 'Лесоустройство в Тольятти — Единая среда',
    description: 'Профессиональное лесоустройство в Тольятти: точные данные и аналитика.',
    images: ['/img/les.png'],
  },
};
    ...
    <>
      ...
      <Script id="json-ld-software" type="application/ld+json">
        {JSON.stringify({
          ...
          areaServed: { "@type": "City", name: "Тольятти" },
          url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/les/tolyatti",
          description: "Лесоустройство в Тольятти: инвентаризация лесного фонда, таксация, разработка проектов.",
        })}
      </Script>
