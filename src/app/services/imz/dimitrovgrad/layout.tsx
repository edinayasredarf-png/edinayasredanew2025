...
export const metadata: Metadata = {
	title: 'Инвентаризация мест захоронений и оцифровка кладбищ в Димитровграде под ключ с созданием цифрового реестра',
	description: 'Профессиональная инвентаризация мест захоронений в Димитровграде: сбор, оцифровка и аналитика данных. Соответствие требованиям и высокая точность.',
	alternates: { canonical: '/services/imz/dimitrovgrad' },
	openGraph: {
		title: 'Инвентаризация мест захоронений в Димитровграде — Единая среда',
		description: 'Сбор, оцифровка и аналитика данных о местах захоронений в Димитровграде. Точность и соответствие требованиям.',
		url: '/services/imz/dimitrovgrad',
		type: 'article',
	...
	twitter: {
		...
		title: 'Инвентаризация мест захоронений в Димитровграде— Единая среда',
		description: 'Профессиональная инвентаризация кладбищ в Димитровграде: точные данные и аналитика.',
		...
		<>
			...
			<Script id="json-ld-software" type="application/ld+json">
				{JSON.stringify({
					...
					operatingSystem: "Web",
					url: "https://xn--80aakbcct4b2aj7m.xn--p1ai/services/imz/dimitrovgrad",
					screenshot: "https://xn--80aakbcct4b2aj7m.xn--p1ai/img/cemetery.png",
					description: "Инвентаризация мест захоронений и кладбищ в Димитровграде с созданием цифрового реестра. Сбор, оцифровка и аналитика данных, соответствие требованиям законодательства.",
					offers: {
						"@type": "Offer",
						price: "0",
						priceCurrency: "RUB",
