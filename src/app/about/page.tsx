  ...
  return (
    <div className="bg-white min-h-screen flex flex-col font-[Raleway] font-medium lining-nums">
      ...
      <header className={`bg-white fixed top-0 left-0 right-0  z-50 w-full transition-all duration-500 ease-out transform ${
        ...
        <div
          className={`absolute left-0 right-0 top-full bg-white/95 backdrop-blur-xl text-[#313131] shadow-2xl z-50 py-8 border-t border-gray-200 transition-all duration-700 ease-[cubic-bezier(0.4,0,0.2,1)] transform ${
          ...
          <nav className="py-4 space-y-2">
            ...
            <div className="relative">
              <button
                ...
                className="w-full flex items-center justify-between py-3 text-[#313131] font-medium text-lg"
              >
                <span>Платформа</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-0 border-t border-gray-200">
        ...
        <div className="relative py-8 border-b lg:border-b-0 lg:border-r border-gray-200">
          ...
          <div className="space-y-6 px-6">
            <div>
              <div className="text-[64px] font-medium text-[#313131] leading-[71.68px]">
                {">"}200
              </div>
              <p className="text-base font-medium text-[#313131] leading-normal mt-1">
            ...
            <div>
              <div className="flex items-baseline">
                <span className="text-[64px] font-medium text-[#313131] leading-[71.68px]">
                  10
                </span>
                <span className="text-[38px] font-medium text-[#313131] leading-[42.56px] ml-2">
                  млн
                </span>
              </div>
              <p className="text-base font-medium text-[#313131] leading-normal mt-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-0 border-b border-gray-200 border-t border-gray-200">
        ...
        <div className="relative py-8 border-b lg:border-b-0 lg:border-r border-gray-200">
          <div className="mb-4 px-6">
            <h3 className="text-xl font-medium text-[#313131] leading-loose">
              Инвентаризация зеленых насаждений
            </h3>
          </div>
