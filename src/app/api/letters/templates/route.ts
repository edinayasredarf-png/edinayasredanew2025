...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    await dbUpdateTemplate({
      ...
      greeting: b.greeting ?? "",
      greeting_size: b.greeting_size ?? 14,
      greeting_bold: b.greeting_bold ?? true,
      header_left_size: b.header_left_size ?? 13,
      header_left_bold: b.header_left_bold ?? false,
      header_right_size: b.header_right_size ?? 13,
      header_right_bold: b.header_right_bold ?? false,
